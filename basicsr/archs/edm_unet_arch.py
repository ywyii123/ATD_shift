...
class SongUNet(torch.nn.Module):
    ...
    def forward(self, x, noise_labels, class_labels, augment_labels=None, lq=None):
        # Mapping.
...
class EDMUNet(torch.nn.Module):
    ...
    def forward(self, x, x_lr, sigma, class_labels=None, force_fp32=False, **model_kwargs):
        ...
        c_in = 1
        ##
        F_x = self.model((c_in * x).to(dtype), c_noise.flatten(), lq=x_lr, class_labels=class_labels, **model_kwargs)
